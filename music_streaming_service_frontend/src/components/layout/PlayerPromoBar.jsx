  ...
  return (
    <div role="region" aria-label="Promo" className="surface" style={{ position: 'sticky', bottom: 0, zIndex: 5 }}>
      <div
        ...
        style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, minHeight: 66, padding: '10px 16px' }}
      >
        <div className="promo__text">
          <div className="promo__title" style={{ fontWeight: 700 }}>Preview of Spotify</div>
          <div className="promo__sub text-muted">Sign up to get unlimited songs and podcasts with occasional ads. No credit card needed.</div>
        </div>
